		...
		<div class="inner-wrap">
			...
			<aside class="left-off-canvas-menu">
				<ul class="off-canvas-list">
					...
					<li><a href="http://www.minecraftmods.com/" target="_blank" title="Minecraft Mods">Minecraft Mods</a></li>
					<li><a href="http://www.minecrafttexturepacks.com/" target="_blank" title="Minecraft Texture Pakcs">Minecraft Texture Packs</a></li>
				</ul>
			</aside>
			...
			<section class="widget section">
				<div class="row" data-equalizer>
					...
					<div class="large-5 medium-5 columns nopad-right" data-equalizer-watch>
						<div class="row collapse">
							<div class="large-12 columns">
